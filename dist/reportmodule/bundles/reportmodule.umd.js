(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common/http'), require('rxjs/operators'), require('@angular/router'), require('@angular/platform-browser'), require('@angular/platform-browser/animations'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('reportmodule', ['exports', '@angular/core', '@angular/animations', '@angular/common/http', 'rxjs/operators', '@angular/router', '@angular/platform-browser', '@angular/platform-browser/animations', '@angular/common', 'rxjs'], factory) :
    (global = global || self, factory(global.reportmodule = {}, global.ng.core, global.ng.animations, global.ng.common.http, global.rxjs.operators, global.ng.router, global.ng.platformBrowser, global.ng.platformBrowser.animations, global.ng.common, global.rxjs));
}(this, (function (exports, core, animations, http, operators, router, platformBrowser, animations$1, common, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ReportmoduleService = /** @class */ (function () {
        function ReportmoduleService() {
        }
        ReportmoduleService.ɵprov = core.ɵɵdefineInjectable({ factory: function ReportmoduleService_Factory() { return new ReportmoduleService(); }, token: ReportmoduleService, providedIn: "root" });
    ...
    var fadeAnimation = animations.trigger('fadeAnimation', [
        animations.transition('* <=> *', [
            animations.query(':enter, :leave', animations.style({ position: 'fixed', width: '90%', top: '10px' }), { optional: true }),
            animations.group([
                animations.query(':enter', [animations.style({ transform: 'translateX(-100%)' }), animations.animate('1.5s ease-out', animations.style({ transform: 'translateX(0%)' }))], {
                    optional: true,
                }),
                animations.query(':leave', [animations.style({ transform: 'translateX(0%)' }), animations.animate('1.5s ease-out', animations.style({ transform: 'translateX(100%)' }))], {
                    optional: true,
                }),
            ])
        ])
    ...
    var AppService = /** @class */ (function () {
        ...
        AppService.ɵprov = core.ɵɵdefineInjectable({ factory: function AppService_Factory() { return new AppService(core.ɵɵinject(http.HttpClient)); }, token: AppService, providedIn: "root" });
    ...
    var CommonService = /** @class */ (function () {
        ...
        CommonService.ɵprov = core.ɵɵdefineInjectable({ factory: function CommonService_Factory() { return new CommonService(); }, token: CommonService, providedIn: "root" });
    ...
    var AppRoutingModule = /** @class */ (function () {
        ...
        AppRoutingModule = __decorate([
            core.NgModule({
                imports: [router.RouterModule.forRoot(routes, { useHash: true, initialNavigation: "disabled" })],
    ...
    var RequestInterceptor = /** @class */ (function () {
        ...
        RequestInterceptor.ɵprov = core.ɵɵdefineInjectable({ factory: function RequestInterceptor_Factory() { return new RequestInterceptor(); }, token: RequestInterceptor, providedIn: "root" });
    ...
    var routes$1 = [];
    var CoreModuleRoutingModule = /** @class */ (function () {
        function CoreModuleRoutingModule() {
        }
        ...
        return CoreModuleRoutingModule;
    }());
    ...
    var routes$2 = [];
    var SharedModuleRoutingModule = /** @class */ (function () {
        function SharedModuleRoutingModule() {
        }
        ...
        return SharedModuleRoutingModule;
    }());
    ...
    var AlertComponent = /** @class */ (function () {
        function AlertComponent() {
            ...
            * output data
            */
            this.choosedVal = new core.EventEmitter();
            /**
    ...
    var AlertInputComponent = /** @class */ (function () {
        function AlertInputComponent(appService) {
            ...
            this.inputAlertInfo = new core.EventEmitter();
        }
    ...
    exports.ReportmoduleComponent = ReportmoduleComponent;
    exports.ReportmoduleModule = ReportmoduleModule;
    exports.ReportmoduleService = ReportmoduleService;
    exports.ɵa = fadeAnimation;
    exports.ɵb = AppService;
    exports.ɵc = CommonService;
    exports.ɵd = AppRoutingModule;
    exports.ɵe = CoreModuleModule;
    exports.ɵf = TranslatePipe;
    exports.ɵg = ToMatrixPipe;
    exports.ɵh = RemoveUnderscorePipe;
    exports.ɵi = CoreModuleRoutingModule;
    exports.ɵj = RequestInterceptor;
    exports.ɵk = ResponseInterceptor;
    exports.ɵl = SharedModuleModule;
    exports.ɵm = AlertComponent;
    exports.ɵn = LanguageComponent;
    exports.ɵo = AlertInputComponent;
    exports.ɵp = ThemeComponent;
    exports.ɵq = CommonLoaderComponent;
    exports.ɵr = SharedModuleRoutingModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=reportmodule.umd.js.map
